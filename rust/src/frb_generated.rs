...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -770494450;
...
fn wire__crate__api__get_build_time_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::get_build_time())?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__get_passphrase_uri_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_rendezvous_server = <Option<String>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::get_passphrase_uri(
                        api_passphrase,
                        api_rendezvous_server,
                    ))?;
                    Ok(output_ok)
                })())
            }
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::init(api_temp_file_path);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__default_rendezvous_url_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__default_transit_url_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__get_build_time_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__get_passphrase_uri_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__init_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__request_file_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__send_files_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__send_folder_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::wormhole::types::build_info::BuildInfo
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::wormhole::types::build_info::BuildInfo>
    for crate::wormhole::types::build_info::BuildInfo
{
    fn into_into_dart(self) -> crate::wormhole::types::build_info::BuildInfo {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
