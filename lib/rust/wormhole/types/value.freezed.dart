...
$Value_IntCopyWith<Value_Int> get copyWith => _$Value_IntCopyWithImpl<Value_Int>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Value_Int&&(identical(other.field0, field0) || other.field0 == field0));
}
...
abstract mixin class $Value_IntCopyWith<$Res> implements $ValueCopyWith<$Res> {
  factory $Value_IntCopyWith(Value_Int value, $Res Function(Value_Int) _then) = _$Value_IntCopyWithImpl;
@useResult
$Res call({
 int field0
});
...
/// @nodoc
class _$Value_IntCopyWithImpl<$Res>
    implements $Value_IntCopyWith<$Res> {
...
@override final  ErrorType field0;
 final  String field1;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Value_ErrorValueCopyWith<Value_ErrorValue> get copyWith => _$Value_ErrorValueCopyWithImpl<Value_ErrorValue>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Value_ErrorValue&&(identical(other.field0, field0) || other.field0 == field0)&&(identical(other.field1, field1) || other.field1 == field1));
}
...
/// @nodoc
abstract mixin class $Value_ErrorValueCopyWith<$Res> implements $ValueCopyWith<$Res> {
  factory $Value_ErrorValueCopyWith(Value_ErrorValue value, $Res Function(Value_ErrorValue) _then) = _$Value_ErrorValueCopyWithImpl;
@useResult
$Res call({
 ErrorType field0, String field1
});
...
null == field0 ? _self.field0 : field0 // ignore: cast_nullable_to_non_nullable
as ErrorType,null == field1 ? _self.field1 : field1 // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Value_ErrorCopyWith<Value_Error> get copyWith => _$Value_ErrorCopyWithImpl<Value_Error>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Value_Error&&(identical(other.field0, field0) || other.field0 == field0));
}
...
/// @nodoc
abstract mixin class $Value_ErrorCopyWith<$Res> implements $ValueCopyWith<$Res> {
  factory $Value_ErrorCopyWith(Value_Error value, $Res Function(Value_Error) _then) = _$Value_ErrorCopyWithImpl;
@useResult
$Res call({
 ErrorType field0
});
...
/// @nodoc
class _$Value_ErrorCopyWithImpl<$Res>
    implements $Value_ErrorCopyWith<$Res> {
...
@override final  ConnectionType field0;
 final  String field1;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Value_ConnectionTypeCopyWith<Value_ConnectionType> get copyWith => _$Value_ConnectionTypeCopyWithImpl<Value_ConnectionType>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Value_ConnectionType&&(identical(other.field0, field0) || other.field0 == field0)&&(identical(other.field1, field1) || other.field1 == field1));
}
...
/// @nodoc
abstract mixin class $Value_ConnectionTypeCopyWith<$Res> implements $ValueCopyWith<$Res> {
  factory $Value_ConnectionTypeCopyWith(Value_ConnectionType value, $Res Function(Value_ConnectionType) _then) = _$Value_ConnectionTypeCopyWithImpl;
@useResult
$Res call({
 ConnectionType field0, String field1
});
...
null == field0 ? _self.field0 : field0 // ignore: cast_nullable_to_non_nullable
as ConnectionType,null == field1 ? _self.field1 : field1 // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
